...
pub fn main() !void {
    ...
    while (candidate < limit and (out[0] != 0 or out[1] != 0 or out[2] != 0)) { // or out[3] > 15)) {
...
const DecimalBytes = struct {
    ...
    fn init(num: u30, decimalBuffer: *[buffSize]u8) DecimalBytes {
        var remainder: u30 = num;
        var idx: u4 = 0;
        var tempIdx: u4 = 0;
